...
public class AppointmentsListModel : PageModel
{
    ...
    private readonly ILogger<AppointmentsListModel> _logger;

    public AppointmentsListModel(AdminApiService adminApiService, ILogger<AppointmentsListModel> logger)
    {
