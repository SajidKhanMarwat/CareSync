...
public class DoctorsListModel : BasePageModel
{
    private readonly ILogger<DoctorsListModel> _logger;
    private readonly AdminApiService _adminApiService;

    public DoctorsListModel(ILogger<DoctorsListModel> logger, AdminApiService adminApiService)
    {
        _logger = logger;
