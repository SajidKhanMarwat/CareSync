...
namespace CareSync.DataLayer.Migrations
{
    ...
    [Migration("20251204163424_navPropertiesAdded")]
    partial class navPropertiesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareSync.DataLayer.Entities.T_LabReports", b =>
                {
                    ...
                    b.Property<int?>("T_LabRequestsLabRequestID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("T_LabRequestsLabRequestID");
            ...
            modelBuilder.Entity("CareSync.DataLayer.Entities.T_LabReports", b =>
                {
                    b.HasOne("CareSync.DataLayer.Entities.T_LabRequests", null)
                        .WithMany("LabReports")
                        .HasForeignKey("T_LabRequestsLabRequestID");
                });
